...
#define LEFT_BUTTON_RECT CGRectMake(0, 0, 160, 85)
...
/**
 A bit of hack for this particular app. It changes the "ON" image on demand, it's mostly for visual purposes.
 */
- (void)changeRightImageOnDemand {
    [_toggleBase changeRightToggleBase];
    [_toggleButton changeRightToggleButton];
}
